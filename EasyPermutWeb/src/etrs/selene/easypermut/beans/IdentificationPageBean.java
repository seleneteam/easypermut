...
public class IdentificationPageBean implements Serializable {
    ...
    @PostConstruct
    public void init() {
        this.u = this.facadeUtilisateur.newInstance();
    }
     ...
     */
    public void flashUtilisateur(Utilisateur u) {
        JsfUtils.putInFlashScope("_utilisateur", u);
    }
    ...
    public String connexion() {
        ...
        Utilisateur utilisateurATester = this.facadeUtilisateur.searchFirstResult("identifiantAnudef", u.getIdentifiantAnudef());

        if (utilisateurATester != null && utilisateurATester.getEstValide() == true) {
            flashUtilisateur(utilisateurATester);
            redirectedUrl = "";
