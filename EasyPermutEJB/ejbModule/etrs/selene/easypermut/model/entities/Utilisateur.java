...
@NamedQueries({ @NamedQuery(name = "Utilisateur.qtParGrade", query = "SELECT COUNT(u) FROM Utilisateur u WHERE u.grade = :grade AND u.estValide = 1"), @NamedQuery(name = "Utilisateur.qtTotal", query = "SELECT COUNT(u) FROM Utilisateur u WHERE u.estValide = 1"), @NamedQuery(name = "Utilisateur.qtInscriptionParMois", query = "SELECT COUNT(u) FROM Utilisateur u WHERE u.dateInscription < :date") })
