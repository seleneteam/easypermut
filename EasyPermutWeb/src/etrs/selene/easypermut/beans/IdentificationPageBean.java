...
public class IdentificationPageBean implements Serializable
{
	 ...
	 */
	public void flashUtilisateur(final Utilisateur u)
	{
	...
	public String connexion()
	{
		...
		Utilisateur utilisateurATester = this.facadeUtilisateur.searchFirstResult("identifiantAnudef", this.u.getIdentifiantAnudef());
